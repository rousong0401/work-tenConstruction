!(function (t, a, e, i) {
    ...
    n.prototype = {
        ...
        , render: function () {
            ...
            this.prevPage = '<a href="javascript:void(0);" class="ui-pagination-page-item prevPage" data-current="' + (a - 1) + '">' + t.prevPageText + '</a>',
            this.nextPage = '<a href="javascript:void(0);" class="ui-pagination-page-item nextPage" data-current="' + (a + 1) + '">' + t.nextPageText + '</a>', 
            this.endPage = '<a href="javascript:void(0);" class="ui-pagination-page-item" data-current="endPage">' + t.endPageText + '</a>', this.checkPage(),
        ...
        , checkPage: function () {
            ...
            e === 1 && (this.prevPage = '<a href="javascript:void(0);" class="ui-pagination-page-item prevPage" data-current="1">' + t.prevPageText + '</a>'),
            e === a && (this.nextPage = '<a href="javascript:void(0);" class="ui-pagination-page-item nextPage" data-current="'+ a +'">' + t.nextPageText + '</a>'), 
